...
const statusCommands = ["loginfo","signalbar","network_type","network_provider","ppp_status","SSID1","station_mac","realtime_tx_thrpt","realtime_rx_thrpt","realtime_tx_bytes","realtime_rx_bytes","realtime_time","monthly_rx_bytes","monthly_tx_bytes","wifi_coverage","lan_ipaddr","wan_ipaddr","wa_inner_version","cr_version","hardware_version","web_version","imei","lte_rsrp","lte_rsrq","lte_snr","lte_rssi","lte_pci","cell_id","wan_active_band","wan_active_channel","MAX_Access_num","AuthMode","sms_unread_num","ACL_mode","wifi_mac_black_list","wifi_hostname_black_list","user_ip_addr","apn_interface_version","profile_name_ui","m_profile_name","profile_name","wan_apn_ui","wan_apn","ppp_auth_mode_ui","ppp_auth_mode","ppp_username_ui","ppp_username","Current_index","apn_mode"].join(",");
